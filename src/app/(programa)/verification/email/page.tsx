...
import { EmailVerifySkeleton } from "@/components/skeleton/emailverify";
        ...
        <div className="py-3 text-white px-8 min-h-screen bg-gradient-to-br from-[#2825eb] via-[#1915eb] to-[#5403d6]">
            ...
            >
                <div className="max-w-lg md:mx-auto md:border md:border-white/40 md:rounded-md md:shadow-2xl md:p-5">
                    <div>
                        <h1 className="text-3xl mb-4 lg:text-5xl text-white font-semibold">
                            Confirme seu cadastro
                        </h1>
                        <p className="text-sm mb-4 lg:text-lg">
                            Insira o código enviado para {data?.email}
                        </p>
                    </div>
                    ...
                    <div>
                        <Button
                            ...
                            className="bg-pink-500 cursor-pointer w-full mb-4"
                        >
                            Confirmar
                        </Button>
